...
public class STLViewActivity extends Activity implements FileListDialog.OnFileListDialogListener {
	...
	public void setUpGraph(){
		...
		XYSeries series1 = new SimpleXYSeries(
				Arrays.asList(CessnaTheta0),          // SimpleXYSeries takes a List so turn our array into a List
	...
	private Number[] CessnaTheta180 = {0, 39.2234,
			5, 39.2483,
			10, 39.2075,
			15, 39.1844,
			20, 39.1234,
	...
	private XYSeries series2 = new SimpleXYSeries(
			Arrays.asList(CessnaTheta180),          // SimpleXYSeries takes a List so turn our array into a List
			SimpleXYSeries.ArrayFormat.XY_VALS_INTERLEAVED, // Y_VALS_ONLY means use the element index as the x value
			"RCS");                             // Set the display title of the series

	public void updatePlot() {
		plot.clear();
		plot.addSeries(series2, new LineAndPointFormatter(Color.RED, Color.GREEN, null, null));
		plot.redraw();
	}
}
